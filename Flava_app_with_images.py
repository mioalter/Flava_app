...
def drop():
    ...
    for i in range(4):
        ...
        url='https://ajax.googleapis.com/ajax/services/search/images?v=1.0&q=%s'%search #&imgsz=medium
#        url='https://ajax.googleapis.com/ajax/services/search/images?v=1.0&q=%s&as_sitesearch=yummly.com&imgsz=medium'%search
